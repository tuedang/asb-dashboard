  ...
  <div class="login-box-body">
    ...
    <form class="" role="form" action="<spring:url value='/j_spring_security_check' />" method="POST">
      <div class="form-group has-feedback">
        <input type="text" name="j_username" class="form-control" id="userId" placeholder="User Id" required="" autofocus value="admin">
        <span class="glyphicon glyphicon-user form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
        <input type="password"  name="j_password"  class="form-control" id="password" placeholder="Password" required="" value="password"/>
